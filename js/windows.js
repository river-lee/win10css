...
if (
  ...
  console.log(
    'Please access this page using a computer for the best experience.'
  );
...
$(document).ready(function () {
  ...
  $('.window').draggable('option', 'handle', '.titleFrame,.window-header');
  // winver
  ...
  $('#npPrint').click(function () {
    ...
    var html =
      '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Print Preview</title></head><body style="background:#ffffff;"><p style="font-family:monospace;text-align:center;">Untitled</p><pre>' +
  ...
  $('#chrome-address').on('change', function () {
    $('#chrome-iframe').attr('src', this.value);
  });

  $('#windowSpread').on('click', function () {
